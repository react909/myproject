...
exports.CHORD_WINDOW_MS = exports.DEFAULT_HIDDEN_ACCESS = exports.SPECIALIST_CHORD = void 0;
exports.matchesSpecialistChord = matchesSpecialistChord;
exports.matchesSpecialistChordWithin = matchesSpecialistChordWithin;
 ...
 */
exports.SPECIALIST_CHORD = 'Ctrl+Alt+Shift+ArrowLeft+ArrowRight';
exports.DEFAULT_HIDDEN_ACCESS = {
    owner: 'Ctrl+Shift+M',
    specialist: exports.SPECIALIST_CHORD,
    /*
 ...
 */
function matchesSpecialistChord(event, pressed) {
 ...
 */
function matchesSpecialistChordWithin(event, pressedAt, now) {
    if (!event.ctrlKey || !event.altKey || !event.shiftKey)
        return false;
    ...
    if (left === undefined || right === undefined)
        return false;
    return now - left <= exports.CHORD_WINDOW_MS && now - right <= exports.CHORD_WINDOW_MS;
}
